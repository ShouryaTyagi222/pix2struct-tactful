# python query_gen.py -i /data/circulars/DATA/LayoutLM/docvqa_dataset/Images -c /data/circulars/DATA/LayoutLM/docvqa_dataset/raw_data -q /data/circulars/DATA/layoutLM+Tactful/query_images

# old tactful
# used to use the given annotated data and split the data into classes
